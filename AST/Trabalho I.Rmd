...
output:
  html_document:
    df_print: paged
authors: Gustavo Hotta (A56865193), Rafael Furlan (A56871487), Ricardo Squassina Lee
  (A56843646)
---
...
#View(PIB)
PIB.ts<-ts(PIB$X1232.PIB, frequency=4, start=c(1991,1))
```
...
```{r}
etsfit.PIB.ts <- ets(PIB.ts[49:96])
etsfit.PIB.ts
...
```{r}
arimafit.PIB.ts <- auto.arima(PIB.ts[49:96])
