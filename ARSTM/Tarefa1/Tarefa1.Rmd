...
ggdendrogram(hc, rotate=FALSE,labels = TRUE)
ggdendrogram(hc, rotate=TRUE)

hc_single <- hclust(dist(grede_two_mode), method = "single")  # explorar com outros m?todos de dist?ncia
ggdendrogram(hc_single, rotate=FALSE,labels = TRUE)

hc_wardD <- hclust(dist(grede_two_mode), method = "ward.D" )  # explorar com outros m?todos de dist?ncia
ggdendrogram(hc_wardD, rotate=FALSE,labels = TRUE)

hc_average <- hclust(dist(grede_two_mode), method = "average" )  # explorar com outros m?todos de dist?ncia
ggdendrogram(hc_average, rotate=FALSE,labels = TRUE)
...
plot(grede_two_mode_a)

```


```{r}
plot(network(grede_two_mode))
plot.igraph(grede_two_mode)
